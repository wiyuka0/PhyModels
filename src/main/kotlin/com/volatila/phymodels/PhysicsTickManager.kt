...
import com.volatila.phymodels.model.ModelManager.Companion.getBlockMatrixWithoutPassableBlock
...
import com.volatila.phymodels.physics.obj.getGeometricCenter
import com.volatila.phymodels.physics.obj.relativeTo
...
//            processRigidBodyRequest()
        ...
        fun updateNearbyBlocks(
            ...
            for ((loc, block) in blockMatrixSnapshot) {
                ...
                if (block.isPassable) {
                    BlockPhysicsUpdater.removeBlock(vec3iJoml)
                } else {
                    BlockPhysicsUpdater.addBlock(vec3iJoml, block.type)
                }
            }
        }
