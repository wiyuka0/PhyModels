...
import com.volatila.phymodels.PhysAPI
...
import com.volatila.phymodels.model.ModelScriptData
...
data class ModelEntity(
    ...
    private fun buildNewTransformation(
        ...
        if(keepLocation) org.joml.Vector3f(
        ...
        ) else org.joml.Vector3f(0f, 0f, 0f),
        Quaternionf(
            rotation.x.toFloat(),
            rotation.y.toFloat(),
            rotation.z.toFloat(),
