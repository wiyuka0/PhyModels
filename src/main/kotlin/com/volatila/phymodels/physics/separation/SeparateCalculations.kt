package com.volatila.phymodels.physics.separation
...
class SeparateCalculations {
    companion object{
        ...
        fun bfs(locationMatrix: List<Model.Vector3i>, startPos: Model.Vector3i): List<Model.Vector3i> {
            val queue = ArrayDeque<Model.Vector3i>()
            val visited = mutableSetOf<Model.Vector3i>()
            val result = mutableListOf<Model.Vector3i>()
            queue.add(startPos)
