...
class ModelManager {
    companion object{
        ...
        fun generateModel(model: Model, location: Location, scale: Float, modelType: BodyType, worldName: String, specialTag: String = "", modelScriptData: ModelScriptData? = null): ModelEntity {
...
// 最终计算偏移量
            ...
            val modelRigidBody = PhysicsRigidBody(compoundShape, mass).apply {
                this.scheduler {
                    setPhysicsLocation(fixedSpawnLoc.toJmeVector3f())
