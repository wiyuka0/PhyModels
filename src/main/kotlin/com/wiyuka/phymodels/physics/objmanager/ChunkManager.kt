...
import com.wiyuka.phymodels.physics.objmanager.BlockPhysicsUtil.BOX_SHAPE
...
class BlockPhysicsUpdater(val worldName: String) {
    companion object {
        val CHUNK_SIZE = 8
    }
...
//        pendingAdd.remove(pos)
    ...
    fun commitChanges(worldName: String) {
        this.dirty = false
        ...
        for ((v3i, material) in pendingAddSnapshot) {
            ...
            if (subRegion == null) {
                ...
                ObjectManager.addObjectToPhysicsWorld(subRegions[material]!!, worldName)
            }
